...
public class OrderTest {
    ...
    public void processOrder_happyFlow() throws OrderStatusException, EntityDoesntExistException  {
    	order = new Order(LocalDate.now(), "Belgie", "Lokeren", "9160", "Honkstraat", 33, "", List.of(new Product("Test product 1", new BigDecimal("10.30")), new Product("Test product 2", new BigDecimal("9.80"))), Status.POSTED, carrier, new Packaging("Packaging", 2, 3, 4, 15, PackagingType.STANDARD, true, supplier), supplier, customer, new Customer());
    ...
    public void processOrder_orderDoesntExist_throwsEntityDoesntExistException () {
    	order = new Order(LocalDate.now(), "Belgie", "Lokeren", "9160", "Honkstraat", 33, "", List.of(new Product("Test product 1", new BigDecimal("10.30")), new Product("Test product 2", new BigDecimal("9.80"))), Status.DISPATCHED, null, new Packaging("Packaging", 2, 3, 4, 15, PackagingType.STANDARD, true, supplier), supplier, customer, new Customer());
